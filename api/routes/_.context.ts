...
const db = {
  ...
  orderRegulatedInfos: memoryStore.collection<OrderRegulatedInfo>(
    'orderRegulatedInfos',
    data.orderRegulatedInfos
  ),
  orderItemsLists: memoryStore.collection<OrderItemsList>(
    'orderItemsLists',
    data.orderItemsLists
  ),
  orderItemBuyerInfos: memoryStore.collection<OrderItemBuyerInfo>(
    'orderItemBuyerInfos',
    data.orderItemBuyerInfos
  ),
  destinations: memoryStore.collection<Destination>(
    'destinations',
    data.destinations
  ),
  subscriptions: memoryStore.collection<Subscription>(
    'subscriptions',
    data.subscriptions
  ),
};
...
export class Context {
  ...
  z: ContextValidator = {
    ...
    orderRegulatedInfos: dep.z.array(
      definitions.orderRegulatedInfoSchema.strict()
    ),
    orderItemsLists: dep.z.array(definitions.orderItemsListSchema.strict()),
    orderItemBuyerInfos: dep.z.array(
      definitions.orderItemBuyerInfoSchema.strict()
    ),
